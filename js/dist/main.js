...
`;function Se(t,e){const s=ht({waitUntilFirstUpdate:!1},e);return(e,o)=>{const{update:r}=e;if(t in e){const i=t;e.update=function(t){if(t.has(i)){const e=t.get(i),r=this[i];e!==r&&(s.waitUntilFirstUpdate&&!this.hasUpdated||this[o](e,r))}r.call(this,t)}}}}function Ee(t,e,s){const o=new CustomEvent(e,ht({bubbles:!0,cancelable:!1,composed:!0,detail:{}},s));return t.dispatchEvent(o),o}function ke(t,e){return new Promise((s=>{t.addEventListener(e,(function o(r){r.target===t&&(t.removeEventListener(e,o),s())}))}))}var Te=t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:s,elements:o}=e;return{kind:s,elements:o,finisher(e){window.customElements.define(t,e)}}})(t,e),Ue=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?ut(ht({},e),{finisher(s){s.createProperty(e.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(s){s.createProperty(e.key,t)}};function Pe(t){return(e,s)=>void 0!==s?((t,e,s)=>{e.constructor.createProperty(s,t)})(t,e,s):Ue(t,e)}function Me(t){return Pe(ut(ht({},t),{state:!0}))}var Ne;function He(t,e){return(({finisher:t,descriptor:e})=>(s,o)=>{var r;if(void 0===o){const o=null!==(r=s.originalKey)&&void 0!==r?r:s.key,i=null!=e?{kind:"method",placement:"prototype",key:o,descriptor:e(s.key)}:ut(ht({},s),{key:o});return null!=t&&(i.finisher=function(e){t(e,o)}),i}{const r=s.constructor;void 0!==e&&Object.defineProperty(s,o,e(o)),null==t||t(r,o)}})({descriptor:s=>{const o={get(){var e,s;return null!==(s=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t))&&void 0!==s?s:null},enumerable:!0,configurable:!0};if(e){const e="symbol"==typeof s?Symbol():"__"+s;o.get=function(){var s,o;return void 0===this[e]&&(this[e]=null!==(o=null===(s=this.renderRoot)||void 0===s?void 0:s.querySelector(t))&&void 0!==o?o:null),this[e]}}return o}})}null===(Ne=window.HTMLSlotElement)||void 0===Ne||Ne.prototype.assignedElements;var ze=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),Le=class extends $e{constructor(){super(...arguments),this.hasSlotController=new At(this,"icon","suffix"),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}async show(){if(!this.open)return this.open=!0,ke(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ke(this,"sl-after-hide")}async toast(){return new Promise((t=>{null===ze.parentElement&&document.body.append(ze),ze.appendChild(this),requestAnimationFrame((()=>{this.clientWidth,this.show()})),this.addEventListener("sl-after-hide",(()=>{ze.removeChild(this),t(),null===ze.querySelector("sl-alert")&&ze.remove()}),{once:!0})}))}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout((()=>this.hide()),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){Ee(this,"sl-show"),this.duration<1/0&&this.restartAutoHide(),await vt(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=_t(this,"alert.show");await bt(this.base,t,e),Ee(this,"sl-after-show")}else{Ee(this,"sl-hide"),clearTimeout(this.autoHideTimeout),await vt(this.base);const{keyframes:t,options:e}=_t(this,"alert.hide");await bt(this.base,t,e),this.base.hidden=!0,Ee(this,"sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}render(){return oe`
    ...
    `}};Le.styles=Ce,pt([He('[part="base"]')],Le.prototype,"base",2),pt([Pe({type:Boolean,reflect:!0})],Le.prototype,"open",2),pt([Pe({type:Boolean,reflect:!0})],Le.prototype,"closable",2),pt([Pe({reflect:!0})],Le.prototype,"variant",2),pt([Pe({type:Number})],Le.prototype,"duration",2),pt([Se("open",{waitUntilFirstUpdate:!0})],Le.prototype,"handleOpenChange",1),pt([Se("duration")],Le.prototype,"handleDurationChange",1),Le=pt([Te("sl-alert")],Le),yt("alert.show",{keyframes:[{opacity:0,transform:"scale(0.8)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}}),yt("alert.hide",{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.8)"}],options:{duration:250,easing:"ease"}});var Oe=(()=>{const t=document.createElement("style");let e;try{document.head.appendChild(t),t.sheet.insertRule(":focus-visible { color: inherit }"),e=!0}catch(t){e=!1}finally{t.remove()}return e})(),Be=Ut(Oe?":focus-visible":":focus"),Re=Pt`
  ${xe}
