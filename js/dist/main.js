...
`,Rs=new Set,Bs=new MutationObserver(Ds),Is=new Map,js=document.documentElement.lang||navigator.language;function Ds(){js=document.documentElement.lang||navigator.language,[...Rs.keys()].map((t=>{"function"==typeof t.requestUpdate&&t.requestUpdate()}))}Bs.observe(document.documentElement,{attributes:!0,attributeFilter:["lang"]});var Fs=class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){Rs.add(this.host)}hostDisconnected(){Rs.delete(this.host)}term(t,...e){return function(t,e,...s){const i=t.toLowerCase().slice(0,2),r=t.length>2?t.toLowerCase():"",o=Is.get(r),n=Is.get(i);let a;if(o&&o[e])a=o[e];else if(n&&n[e])a=n[e];else{if(!Ns||!Ns[e])return console.error(`No translation found for: ${e}`),e;a=Ns[e]}return"function"==typeof a?a(...s):a}(this.host.lang||js,t,...e)}date(t,e){return function(t,e,s){return e=new Date(e),new Intl.DateTimeFormat(t,s).format(e)}(this.host.lang||js,t,e)}number(t,e){return function(t,e,s){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(t,s).format(e)}(this.host.lang||js,t,e)}relativeTime(t,e,s){return function(t,e,s,i){return new Intl.RelativeTimeFormat(t,i).format(e,s)}(this.host.lang||js,t,e,s)}};function Ws(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}function Vs(t,e,s="vertical",i="smooth"){const r=Ws(t,e),o=r.top+e.scrollTop,n=r.left+e.scrollLeft,a=e.scrollLeft,l=e.scrollLeft+e.offsetWidth,h=e.scrollTop,c=e.scrollTop+e.offsetHeight;"horizontal"!==s&&"both"!==s||(n<a?e.scrollTo({left:n,behavior:i}):n+t.clientWidth>l&&e.scrollTo({left:n-e.offsetWidth+t.clientWidth,behavior:i})),"vertical"!==s&&"both"!==s||(o<h?e.scrollTo({top:o,behavior:i}):o+t.clientHeight>c&&e.scrollTo({top:o-e.offsetHeight+t.clientHeight,behavior:i}))}!function(...t){t.map((t=>{const e=t.$code.toLowerCase();Is.set(e,t),Ns||(Ns=t)})),Ds()}({$code:"en",$name:"English",$dir:"ltr",close:"Close",copy:"Copy",progress:"Progress",resize:"Resize",scroll_to_end:"Scroll to end",scroll_to_start:"Scroll to start",select_a_color_from_the_screen:"Select a color from the screen",toggle_color_format:"Toggle color format"});var qs=class extends $e{constructor(){super(...arguments),this.localize=new Fs(this),this.tabs=[],this.panels=[],this.hasScrollControls=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((()=>{this.preventIndicatorTransition(),this.repositionIndicator(),this.updateScrollControls()})),this.mutationObserver=new MutationObserver((t=>{t.some((t=>!["aria-labelledby","aria-controls"].includes(t.attributeName)))&&setTimeout((()=>this.setAriaLabels())),t.some((t=>"disabled"===t.attributeName))&&this.syncTabsAndPanels()})),this.updateComplete.then((()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),new IntersectionObserver(((t,e)=>{t[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(this.getActiveTab()||this.tabs[0],{emitEvents:!1}),e.unobserve(t[0].target))})).observe(this.tabGroup)}))}disconnectedCallback(){this.mutationObserver.disconnect(),this.resizeObserver.unobserve(this.nav)}show(t){const e=this.tabs.find((e=>e.panel===t));e&&this.setActiveTab(e,{scrollBehavior:"smooth"})}getAllTabs(t=!1){return[...this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()].filter((e=>t?"sl-tab"===e.tagName.toLowerCase():"sl-tab"===e.tagName.toLowerCase()&&!e.disabled))}getAllPanels(){return[...this.body.querySelector("slot").assignedElements()].filter((t=>"sl-tab-panel"===t.tagName.toLowerCase()))}getActiveTab(){return this.tabs.find((t=>t.active))}handleClick(t){const e=t.target.closest("sl-tab");(null==e?void 0:e.closest("sl-tab-group"))===this&&e&&this.setActiveTab(e,{scrollBehavior:"smooth"})}handleKeyDown(t){const e=t.target.closest("sl-tab");if((null==e?void 0:e.closest("sl-tab-group"))===this&&(["Enter"," "].includes(t.key)&&e&&(this.setActiveTab(e,{scrollBehavior:"smooth"}),t.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(t.key))){const e=document.activeElement;if(e&&"sl-tab"===e.tagName.toLowerCase()){let s=this.tabs.indexOf(e);"Home"===t.key?s=0:"End"===t.key?s=this.tabs.length-1:["top","bottom"].includes(this.placement)&&"ArrowLeft"===t.key||["start","end"].includes(this.placement)&&"ArrowUp"===t.key?s=Math.max(0,s-1):(["top","bottom"].includes(this.placement)&&"ArrowRight"===t.key||["start","end"].includes(this.placement)&&"ArrowDown"===t.key)&&(s=Math.min(this.tabs.length-1,s+1)),this.tabs[s].focus({preventScroll:!0}),"auto"===this.activation&&this.setActiveTab(this.tabs[s],{scrollBehavior:"smooth"}),["top","bottom"].includes(this.placement)&&Vs(this.tabs[s],this.nav,"horizontal"),t.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}updateScrollControls(){this.nav&&(this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth)}setActiveTab(t,e){if(e=Object.assign({emitEvents:!0,scrollBehavior:"auto"},e),t&&t!==this.activeTab&&!t.disabled){const s=this.activeTab;this.activeTab=t,this.tabs.map((t=>t.active=t===this.activeTab)),this.panels.map((t=>t.active=t.name===this.activeTab.panel)),this.syncIndicator(),["top","bottom"].includes(this.placement)&&Vs(this.activeTab,this.nav,"horizontal",e.scrollBehavior),e.emitEvents&&(s&&Ie(this,"sl-tab-hide",{detail:{name:s.panel}}),Ie(this,"sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.map((t=>{const e=this.panels.find((e=>e.name===t.panel));e&&(t.setAttribute("aria-controls",e.getAttribute("id")),e.setAttribute("aria-labelledby",t.getAttribute("id")))}))}syncIndicator(){if(this.indicator){if(!this.getActiveTab())return void(this.indicator.style.display="none");this.indicator.style.display="block",this.repositionIndicator()}}repositionIndicator(){const t=this.getActiveTab();if(!t)return;const e=t.clientWidth,s=t.clientHeight,i=Ws(t,this.nav),r=i.top+this.nav.scrollTop,o=i.left+this.nav.scrollLeft;switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${e}px`,this.indicator.style.height="auto",this.indicator.style.transform=`translateX(${o}px)`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${s}px`,this.indicator.style.transform=`translateY(${r}px)`}}preventIndicatorTransition(){const t=this.indicator.style.transition;this.indicator.style.transition="none",requestAnimationFrame((()=>{this.indicator.style.transition=t}))}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.panels=this.getAllPanels(),this.syncIndicator()}render(){return jt`
    ...
    `}};qs.styles=Ls,ut([qe(".tab-group")],qs.prototype,"tabGroup",2),ut([qe(".tab-group__body")],qs.prototype,"body",2),ut([qe(".tab-group__nav")],qs.prototype,"nav",2),ut([qe(".tab-group__indicator")],qs.prototype,"indicator",2),ut([Ve()],qs.prototype,"hasScrollControls",2),ut([We()],qs.prototype,"placement",2),ut([We()],qs.prototype,"activation",2),ut([We({attribute:"no-scroll-controls",type:Boolean})],qs.prototype,"noScrollControls",2),ut([We()],qs.prototype,"lang",2),ut([Be("noScrollControls")],qs.prototype,"updateScrollControls",1),ut([Be("placement")],qs.prototype,"syncIndicator",1),qs=ut([De("sl-tab-group")],qs);var Ks=ce`
  ${Ne}
...
`,Gs=0,Js=class extends $e{constructor(){super(...arguments),this.localize=new Fs(this),this.componentId="sl-tab-"+ ++Gs,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1}focus(t){this.tab.focus(t)}blur(){this.tab.blur()}handleCloseClick(){Ie(this,"sl-close")}render(){return this.id=this.id||this.componentId,jt`
      <div
        part="base"
    ...
    `}};Js.styles=Ks,ut([qe(".tab")],Js.prototype,"tab",2),ut([We({reflect:!0})],Js.prototype,"panel",2),ut([We({type:Boolean,reflect:!0})],Js.prototype,"active",2),ut([We({type:Boolean})],Js.prototype,"closable",2),ut([We({type:Boolean,reflect:!0})],Js.prototype,"disabled",2),ut([We()],Js.prototype,"lang",2),Js=ut([De("sl-tab")],Js);var Ys=ce`
  ${Ne}
...
`,Zs=0,Qs=class extends $e{constructor(){super(...arguments),this.componentId="sl-tab-panel-"+ ++Zs,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id||this.componentId}render(){return this.style.display=this.active?"block":"none",jt`
      <div part="base" class="tab-panel" role="tabpanel" aria-hidden=${this.active?"false":"true"}>
        <slot></slot>
      </div>
    `}};Qs.styles=Ys,ut([We({reflect:!0})],Qs.prototype,"name",2),ut([We({type:Boolean,reflect:!0})],Qs.prototype,"active",2),Qs=ut([De("sl-tab-panel")],Qs);const Xs=bs(class extends gs{constructor(t){super(t),this.tt=new WeakMap}render(t){return[t]}update(t,[e]){if(ms(this.it)&&(!ms(e)||this.it.strings!==e.strings)){const e=As(t).pop();let s=this.tt.get(this.it.strings);if(void 0===s){const t=document.createDocumentFragment();s=R(N,t),s.setConnected(!1),this.tt.set(this.it.strings,s)}ws(s,[e]),_s(s,void 0,e)}if(ms(e)){if(!ms(this.it)||this.it.strings!==e.strings){const s=this.tt.get(e.strings);if(void 0!==s){const e=As(s).pop();(t=>{t._$AR()})(t),_s(t,void 0,e),ws(t,[e])}}this.it=e}else this.it=void 0;return this.render(e)}});class ti extends et{static properties={tabname:{type:String},info:{type:Object},visible:{type:Boolean,attribute:!1}};checkVisible(t,e){for(const e of t)"active"===e.attributeName&&(this.tabname===e.target.id?this.visible=!0:this.visible=!1)}connectedCallback(){super.connectedCallback();const t=this.checkVisible.bind(this);this.observer=new MutationObserver(t),this.observer.observe(this.parentElement,{attributes:!0})}disconnectedCallback(){super.disconnectedCallback(),this.observer.disconnect()}visibleTemplate(){throw new Error("Inherit from this class and implement 'visibleTemplate'.")}render(){return z`
        ${Xs(this.visible?z`${this.visibleTemplate()}`:z``)}`}}customElements.define("wult-tab",ti);class ei extends et{static styles=o`
    .plot {
        position: relative;
        height: 100%;
        width: 100%;
  ...
  `;static properties={path:{type:String}};render(){return z`
        ...
        `}}customElements.define("diagram-element",ei),customElements.define("smry-tbl",class extends Hs{parseMetric(t){const e=t[0].split("|");return z`
        ...
        `}async parseSrc(){let t,e=z``;for await(const s of this.makeTextFileLineIterator(this.src)){const i=s.split(";"),r=i[0];if(i.shift(),"H"===r)for(const t of i)e=z`${e}<th>${t}</th>`,this.cols=this.cols+1;else if("M"===r)t=this.parseMetric(i);else{const s=z`${i.map((t=>this.parseSummaryFunc(t)))}`;e=z`
                ...
                `,t&&(t=void 0)}}return z`<table width=${this.getWidth(this.cols)}>${e}</table>`}constructor(){super(),this.cols=0}connectedCallback(){super.connectedCallback(),this.parseSrc().then((t=>{this.template=t}))}});class si extends ti{static styles=o`
        .grid {
            display: grid;
            width: 100%;
  ...
  `;static properties={paths:{type:Array},smrytblpath:{type:String}};visibleTemplate(){return z`
        ...
        `}render(){return super.render()}}customElements.define("wult-metric-tab",si);class ii extends et{static styles=o`
      /*
    ...
    `;static properties={tabFile:{type:String},tabs:{type:Object,attribute:!1},fetchFailed:{type:Boolean,attribute:!1}};updated(t){t.has("tabFile")&&fetch(this.tabFile).then((t=>t.json())).then((t=>{this.tabs=t}))}tabTemplate(t){return t.tabs?z`
      ...
      `}render(){return this.fetchFailed?this.corsWarning():z`
        ...
        `}}customElements.define("report-page",ri),es("shoelace")})();