...
`;function Ue(t,e,i){return new Promise((s=>{if((null==i?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const o=t.animate(e,me(fe({},i),{duration:window.matchMedia("(prefers-reduced-motion: reduce)").matches?0:i.duration}));o.addEventListener("cancel",s,{once:!0}),o.addEventListener("finish",s,{once:!0})}))}function De(t){return Promise.all(t.getAnimations().map((t=>new Promise((e=>{const i=requestAnimationFrame(e);t.addEventListener("cancel",(()=>i),{once:!0}),t.addEventListener("finish",(()=>i),{once:!0}),t.cancel()})))))}function He(t,e){return t.map((t=>me(fe({},t),{height:"auto"===t.height?`${e}px`:t.height})))}var Oe=new Map,Ne=new WeakMap;function Re(t,e){return"rtl"===e.toLowerCase()?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function Fe(t,e){Oe.set(t,function(t){return null!=t?t:{keyframes:[],options:{duration:0}}}(e))}function Me(t,e,i){const s=Ne.get(t);if(null==s?void 0:s[e])return Re(s[e],i.dir);const o=Oe.get(e);return o?Re(o,i.dir):{keyframes:[],options:{duration:0}}}var Be,Ve=new Set,je=new MutationObserver(Ye),qe=new Map,We=document.documentElement.dir||"ltr",Ke=document.documentElement.lang||navigator.language;function Ye(){We=document.documentElement.dir||"ltr",Ke=document.documentElement.lang||navigator.language,[...Ve.keys()].map((t=>{"function"==typeof t.requestUpdate&&t.requestUpdate()}))}je.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]});var Xe=class extends class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){Ve.add(this.host)}hostDisconnected(){Ve.delete(this.host)}dir(){return`${this.host.dir||We}`.toLowerCase()}lang(){return`${this.host.lang||Ke}`.toLowerCase()}term(t,...e){const i=this.lang().toLowerCase().slice(0,2),s=this.lang().length>2?this.lang().toLowerCase():"",o=qe.get(s),r=qe.get(i);let n;if(o&&o[t])n=o[t];else if(r&&r[t])n=r[t];else{if(!Be||!Be[t])return console.error(`No translation found for: ${String(t)}`),t;n=Be[t]}return"function"==typeof n?n(...e):n}date(t,e){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),e).format(t)}number(t,e){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),e).format(t)}relativeTime(t,e,i){return new Intl.RelativeTimeFormat(this.lang(),i).format(t,e)}}{};!function(...t){t.map((t=>{const e=t.$code.toLowerCase();qe.has(e)?qe.set(e,Object.assign(Object.assign({},qe.get(e)),t)):qe.set(e,t),Be||(Be=t)})),Ye()}({$code:"en",$name:"English",$dir:"ltr",clearEntry:"Clear entry",close:"Close",copy:"Copy",currentValue:"Current value",hidePassword:"Hide password",loading:"Loading",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",toggleColorFormat:"Toggle color format"});var Ze=class{constructor(t,...e){this.slotNames=[],(this.host=t).addController(this),this.slotNames=e,this.handleSlotChange=this.handleSlotChange.bind(this)}hasDefaultSlot(){return[...this.host.childNodes].some((t=>{if(t.nodeType===t.TEXT_NODE&&""!==t.textContent.trim())return!0;if(t.nodeType===t.ELEMENT_NODE){const e=t;if("sl-visually-hidden"===e.tagName.toLowerCase())return!1;if(!e.hasAttribute("slot"))return!0}return!1}))}hasNamedSlot(t){return null!==this.host.querySelector(`:scope > [slot="${t}"]`)}test(t){return"[default]"===t?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}handleSlotChange(t){const e=t.target;(this.slotNames.includes("[default]")&&!e.name||e.name&&this.slotNames.includes(e.name))&&this.host.requestUpdate()}},Ge=t=>(...e)=>({_$litDirective$:t,values:e}),Je=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}},Qe=Ge(class extends Je{constructor(t){var e;if(super(t),1!==t.type||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){var i,s;if(void 0===this.et){this.et=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!(null===(i=this.st)||void 0===i?void 0:i.has(t))&&this.et.add(t);return this.render(e)}const o=t.element.classList;this.et.forEach((t=>{t in e||(o.remove(t),this.et.delete(t))}));for(const t in e){const i=!!e[t];i===this.et.has(t)||(null===(s=this.st)||void 0===s?void 0:s.has(t))||(i?(o.add(t),this.et.add(t)):(o.remove(t),this.et.delete(t)))}return Rt}}),ti=t=>null!=t?t:Ft;function ei(t,e,i){const s=new CustomEvent(e,fe({bubbles:!0,cancelable:!1,composed:!0,detail:{}},i));return t.dispatchEvent(s),s}function ii(t,e){return new Promise((i=>{t.addEventListener(e,(function s(o){o.target===t&&(t.removeEventListener(e,s),i())}))}))}var si=class extends oe{constructor(){super(...arguments),this.hasSlotController=new Ze(this,"footer"),this.localize=new Xe(this),this.open=!1,this.label="",this.noHeader=!1}connectedCallback(){super.connectedCallback(),this.modal=new class{constructor(t){this.tabDirection="forward",this.element=t,this.handleFocusIn=this.handleFocusIn.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleKeyUp=this.handleKeyUp.bind(this)}activate(){Se.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Se=Se.filter((t=>t!==this.element)),document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Se[Se.length-1]===this.element}checkFocus(){if(this.isActive()&&!this.element.matches(":focus-within")){const{start:t,end:e}=function(t){var e,i;const s=[];return function t(e){e instanceof HTMLElement&&(s.push(e),null!==e.shadowRoot&&"open"===e.shadowRoot.mode&&t(e.shadowRoot)),[...e.children].forEach((e=>t(e)))}(t),{start:null!=(e=s.find((t=>Ee(t))))?e:null,end:null!=(i=s.reverse().find((t=>Ee(t))))?i:null}}(this.element),i="forward"===this.tabDirection?t:e;"function"==typeof(null==i?void 0:i.focus)&&i.focus({preventScroll:!0})}}handleFocusIn(){this.checkFocus()}handleKeyDown(t){"Tab"===t.key&&t.shiftKey&&(this.tabDirection="backward"),requestAnimationFrame((()=>this.checkFocus()))}handleKeyUp(){this.tabDirection="forward"}}(this)}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.modal.activate(),ze(this))}disconnectedCallback(){super.disconnectedCallback(),Pe(this)}async show(){if(!this.open)return this.open=!0,ii(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ii(this,"sl-after-hide")}requestClose(t){if(ei(this,"sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const t=Me(this,"dialog.denyClose",{dir:this.localize.dir()});Ue(this.panel,t.keyframes,t.options)}else this.hide()}handleKeyDown(t){"Escape"===t.key&&(t.stopPropagation(),this.requestClose("keyboard"))}async handleOpenChange(){if(this.open){ei(this,"sl-show"),this.originalTrigger=document.activeElement,this.modal.activate(),ze(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([De(this.dialog),De(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame((()=>{ei(this,"sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")}));const e=Me(this,"dialog.show",{dir:this.localize.dir()}),i=Me(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([Ue(this.panel,e.keyframes,e.options),Ue(this.overlay,i.keyframes,i.options)]),ei(this,"sl-after-show")}else{ei(this,"sl-hide"),this.modal.deactivate(),await Promise.all([De(this.dialog),De(this.overlay)]);const t=Me(this,"dialog.hide",{dir:this.localize.dir()}),e=Me(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([Ue(this.panel,t.keyframes,t.options),Ue(this.overlay,e.keyframes,e.options)]),this.dialog.hidden=!0,Pe(this);const i=this.originalTrigger;"function"==typeof(null==i?void 0:i.focus)&&setTimeout((()=>i.focus())),ei(this,"sl-after-hide")}}render(){return Ot`
    ...
    `}};si.styles=Ie,ge([Ae(".dialog")],si.prototype,"dialog",2),ge([Ae(".dialog__panel")],si.prototype,"panel",2),ge([Ae(".dialog__overlay")],si.prototype,"overlay",2),ge([$e({type:Boolean,reflect:!0})],si.prototype,"open",2),ge([$e({reflect:!0})],si.prototype,"label",2),ge([$e({attribute:"no-header",type:Boolean,reflect:!0})],si.prototype,"noHeader",2),ge([ye("open",{waitUntilFirstUpdate:!0})],si.prototype,"handleOpenChange",1),si=ge([_e("sl-dialog")],si),Fe("dialog.show",{keyframes:[{opacity:0,transform:"scale(0.8)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}}),Fe("dialog.hide",{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.8)"}],options:{duration:250,easing:"ease"}}),Fe("dialog.denyClose",{keyframes:[{transform:"scale(1)"},{transform:"scale(1.02)"},{transform:"scale(1)"}],options:{duration:250}}),Fe("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),Fe("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});var oi=ct`
  ${ne}
...
`,$i=class extends Je{constructor(t){if(super(t),this.it=Ft,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Ft||null==t)return this.ft=void 0,this.it=t;if(t===Rt)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this.ft;this.it=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}};$i.directiveName="unsafeHTML",$i.resultType=1,Ge($i);var xi=class extends $i{};xi.directiveName="unsafeSVG",xi.resultType=2;var ki,Ai=Ge(xi),Ci=class extends oe{constructor(){super(...arguments),this.svg="",this.label="",this.library="default"}connectedCallback(){super.connectedCallback(),mi.push(this)}firstUpdated(){this.setIcon()}disconnectedCallback(){var t;super.disconnectedCallback(),t=this,mi=mi.filter((e=>e!==t))}getUrl(){const t=gi(this.library);return this.name&&t?t.resolver(this.name):this.src}redraw(){this.setIcon()}async setIcon(){var t;const e=gi(this.library),i=this.getUrl();if(ki||(ki=new DOMParser),i)try{const s=await async function(t){if(_i.has(t))return _i.get(t);const e=await function(t,e="cors"){if(yi.has(t))return yi.get(t);const i=fetch(t,{mode:e}).then((async t=>({ok:t.ok,status:t.status,html:await t.text()})));return yi.set(t,i),i}(t),i={ok:e.ok,status:e.status,svg:null};if(e.ok){const t=document.createElement("div");t.innerHTML=e.html;const s=t.firstElementChild;i.svg="svg"===(null==s?void 0:s.tagName.toLowerCase())?s.outerHTML:""}return _i.set(t,i),i}(i);if(i!==this.getUrl())return;if(s.ok){const i=ki.parseFromString(s.svg,"text/html").body.querySelector("svg");null!==i?(null==(t=null==e?void 0:e.mutator)||t.call(e,i),this.svg=i.outerHTML,ei(this,"sl-load")):(this.svg="",ei(this,"sl-error"))}else this.svg="",ei(this,"sl-error")}catch(t){ei(this,"sl-error")}else this.svg.length>0&&(this.svg="")}handleChange(){this.setIcon()}render(){const t="string"==typeof this.label&&this.label.length>0;return Ot` <div
    ...
    `;getWidth(t){return Math.min(100,20*(t-2))}async*makeTextFileLineIterator(t){const e=new TextDecoder("utf-8"),i=t.stream().getReader();let{value:s,done:o}=await i.read();s=s?e.decode(s,{stream:!0}):"";const r=/\r\n|\n|\r/gm;let n=0;for(;;){const t=r.exec(s);if(t)yield s.substring(n,t.index),n=r.lastIndex;else{if(o)break;const t=s.substr(n);({value:s,done:o}=await i.read()),s=t+(s?e.decode(s,{stream:!0}):""),n=r.lastIndex=0}}n<s.length&&(yield s.substr(n))}render(){if(!this.file)return H``;const t=this.parseSrc();return H`${Ri(t,H``)}`}}customElements.define("sc-report-table",Mi),customElements.define("sc-intro-tbl",class extends Mi{parseHeader(t){const e=t.split(";");return H`
            <tr>
                ${e.map((t=>H`<th>${t}</th>`))}
            </tr>
        `}parseRow(t){let e=H``,i=!0;for(const s of t.split(";")){const[t,o,r]=s.split("|");let n=H`${t}`;r&&(n=H`<a href=${r}>${n}</a>`),o&&(n=H`<abbr title=${o}>${n}</abbr>`),i?(e=H`${e}
                ...
                `}return H`<tr>${e}</tr>`}async parseSrc(){const t=this.makeTextFileLineIterator(this.file);let e=await t.next();if(e=e.value,!e.startsWith("H;"))throw new Fi("first line in intro table file should be a header.");e=e.slice(2);let i=this.parseHeader(e);for await(let e of t){if(!e.startsWith("R;"))throw new Fi("lines following the first should all be normal table rows.");e=e.slice(2),i=H`${i}${this.parseRow(e)}`}return H`<table>${i}</table>`}});var Bi=ct`
  ${ne}
...
`,Vi=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),ji=class extends oe{constructor(){super(...arguments),this.hasSlotController=new Ze(this,"icon","suffix"),this.localize=new Xe(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}async show(){if(!this.open)return this.open=!0,ii(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ii(this,"sl-after-hide")}async toast(){return new Promise((t=>{null===Vi.parentElement&&document.body.append(Vi),Vi.appendChild(this),requestAnimationFrame((()=>{this.clientWidth,this.show()})),this.addEventListener("sl-after-hide",(()=>{Vi.removeChild(this),t(),null===Vi.querySelector("sl-alert")&&Vi.remove()}),{once:!0})}))}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout((()=>this.hide()),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){ei(this,"sl-show"),this.duration<1/0&&this.restartAutoHide(),await De(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=Me(this,"alert.show",{dir:this.localize.dir()});await Ue(this.base,t,e),ei(this,"sl-after-show")}else{ei(this,"sl-hide"),clearTimeout(this.autoHideTimeout),await De(this.base);const{keyframes:t,options:e}=Me(this,"alert.hide",{dir:this.localize.dir()});await Ue(this.base,t,e),this.base.hidden=!0,ei(this,"sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}render(){return Ot`
    ...
    `}};ji.styles=Bi,ge([Ae('[part="base"]')],ji.prototype,"base",2),ge([$e({type:Boolean,reflect:!0})],ji.prototype,"open",2),ge([$e({type:Boolean,reflect:!0})],ji.prototype,"closable",2),ge([$e({reflect:!0})],ji.prototype,"variant",2),ge([$e({type:Number})],ji.prototype,"duration",2),ge([ye("open",{waitUntilFirstUpdate:!0})],ji.prototype,"handleOpenChange",1),ge([ye("duration")],ji.prototype,"handleDurationChange",1),ji=ge([_e("sl-alert")],ji),Fe("alert.show",{keyframes:[{opacity:0,transform:"scale(0.8)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}}),Fe("alert.hide",{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.8)"}],options:{duration:250,easing:"ease"}});var qi=ct`
  ${ne}
...
`,ks=class extends oe{constructor(){super(...arguments),this.localize=new Xe(this),this.open=!1,this.disabled=!1}firstUpdated(){this.body.hidden=!this.open,this.body.style.height=this.open?"auto":"0"}async show(){if(!this.open&&!this.disabled)return this.open=!0,ii(this,"sl-after-show")}async hide(){if(this.open&&!this.disabled)return this.open=!1,ii(this,"sl-after-hide")}handleSummaryClick(){this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.open?this.hide():this.show()),"ArrowUp"!==t.key&&"ArrowLeft"!==t.key||(t.preventDefault(),this.hide()),"ArrowDown"!==t.key&&"ArrowRight"!==t.key||(t.preventDefault(),this.show())}async handleOpenChange(){if(this.open){ei(this,"sl-show"),await De(this.body),this.body.hidden=!1;const{keyframes:t,options:e}=Me(this,"details.show",{dir:this.localize.dir()});await Ue(this.body,He(t,this.body.scrollHeight),e),this.body.style.height="auto",ei(this,"sl-after-show")}else{ei(this,"sl-hide"),await De(this.body);const{keyframes:t,options:e}=Me(this,"details.hide",{dir:this.localize.dir()});await Ue(this.body,He(t,this.body.scrollHeight),e),this.body.hidden=!0,this.body.style.height="auto",ei(this,"sl-after-hide")}}render(){return Ot`
      <div
        part="base"
  ...
  `;static properties={paths:{type:Array},fpreviews:{type:Array},smrytblpath:{type:String},smrytblfile:{type:Blob}};render(){return this.smrytblpath&&!this.smrytblfile&&fetch(this.smrytblpath).then((t=>t.blob())).then((t=>{this.smrytblfile=t})),H`
        ...
        `:H``}constructor(){super(),this.dataTabs=[],this.firstTab=""}});class Ls extends it{static styles=r`
        /*
    ...
    `;static properties={tabs:{type:Object}};get _tabPanels(){return this.renderRoot.querySelectorAll("sc-tab-panel")}get _tabGroup(){return this.renderRoot.querySelector("sl-tab-group")}getTabPanel(t){for(const e of this._tabPanels)if(e.hasDataTab(t))return e}getActiveTab(){const t=this._tabGroup.querySelectorAll("sl-tab");for(const e of t)if(e.active)return e;throw Error("BUG: unable to find active tab")}getActiveDataTab(){const t=this.getActiveTab();for(const e of this._tabPanels)if(e.tab.name===t.panel)return e.activeDataTab;throw Error("BUG: unable to find active data tab")}show(t=location.hash.substring(1)){for(const e of this._tabPanels)e.show(t)}firstUpdated(){this.tabChangeHandler=()=>{location.href=`#${this.getActiveDataTab().id}`},this._tabGroup.addEventListener("sl-tab-show",this.tabChangeHandler),this._tabGroup.updateComplete.then((()=>{const t=location.hash.substring(1);if(!t)return void(location.hash=`${this._tabPanels[0].firstTab}`);const e=this.getTabPanel(t);e.updateComplete.then((()=>{e.show(t),this._tabGroup.show(e.parentElement.name)}))}))}connectedCallback(){super.connectedCallback(),this.hashHandler=()=>{this.show()},window.addEventListener("hashchange",this.hashHandler,!1)}disconnectedCallback(){window.removeEventListener("hashchange",this.hashHandler),this._tabGroup.removeEventListener("sl-tab-show",this.tabChangeHandler)}render(){return this.tabs?H`
      ...
      `:H``}}customElements.define("sc-tab-group",Ls);class Is extends it{static properties={introtbl:{type:Object},src:{type:String},reportInfo:{type:Object},toolname:{type:String},titleDescr:{type:String},tabs:{type:Object},fetchFailed:{type:Boolean,attribute:!1}};static styles=r`
        .report-head {
            display: flex;
            flex-direction: column;
            align-items: center;
    ...
    `;get _corsWarning(){return this.renderRoot.querySelector(".cors-warning")}initRepProps(){this.toolname=this.reportInfo.toolname,this.titleDescr=this.reportInfo.title_descr}parseReportInfo(t){this.reportInfo=t,this.initRepProps(),fetch(t.intro_tbl).then((t=>t.blob())).then((t=>{this.introtbl=t})),fetch(t.tab_file).then((t=>t.json())).then((async t=>{this.tabs=t}))}connectedCallback(){fetch(this.src).then((t=>t.json())).then((t=>this.parseReportInfo(t))).catch((t=>{if(!(t instanceof TypeError))throw t;this.fetchFailed=!0})),super.connectedCallback()}updated(t){t.has("fetchFailed")&&this.fetchFailed&&this._corsWarning.addEventListener("sl-request-close",(t=>{t.preventDefault()}))}corsWarning(){return H`
        ...
        `}findFile(t){const e=Object.keys(this.files);for(const i of e)if(i.endsWith(t))return this.files[i];throw Error(`unable to find an uploaded file ending with '${t}'.`)}async extractTabs(t,e){for(const i of t)i.smrytblpath&&(i.smrytblfile=e?await fetch(i.smrytblpath).then((t=>t.blob())):this.findFile(i.smrytblpath)),i.tabs&&(i.tabs=await this.extractTabs(i.tabs,e));return t}async processUploadedFiles(){const t=this.renderRoot.getElementById("upload-files");this.files={};for(const e of t.files)this.files[e.webkitRelativePath]=e;const e=await this.findFile("report_info.json").arrayBuffer();this.reportInfo=JSON.parse((new TextDecoder).decode(e)),this.introtbl=this.findFile(this.reportInfo.intro_tbl);const i=await this.findFile(this.reportInfo.tab_file).arrayBuffer().then((t=>JSON.parse((new TextDecoder).decode(t))));this.tabs=await this.extractTabs(i,!1),this.initRepProps(),this.fetchFailed=!1}constructor(){super(),this.fetchFailed=!1,this.reportInfo={}}render(){return this.fetchFailed?this.corsWarning():H`
            <div class="report-head">
                ${this.toolname?H`<h1 class="report-title">${this.toolname} report</h1>`:H``}
                ${this.titleDescr?H`
