...
`,Yi=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),Gi=class extends Te{constructor(){super(...arguments),this.hasSlotController=new ii(this,"icon","suffix"),this.localize=new ei(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout((()=>this.hide()),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await Be(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=We(this,"alert.show",{dir:this.localize.dir()});await Ne(this.base,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),await Be(this.base);const{keyframes:t,options:e}=We(this,"alert.hide",{dir:this.localize.dir()});await Ne(this.base,t,e),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Re(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Re(this,"sl-after-hide")}async toast(){return new Promise((t=>{null===Yi.parentElement&&document.body.append(Yi),Yi.appendChild(this),requestAnimationFrame((()=>{this.clientWidth,this.show()})),this.addEventListener("sl-after-hide",(()=>{Yi.removeChild(this),t(),null===Yi.querySelector("sl-alert")&&Yi.remove()}),{once:!0})}))}render(){return Bt`
      <div
        part="base"
...
`,Ss=class extends Te{constructor(){super(...arguments),this.localize=new ei(this),this.open=!1,this.disabled=!1}firstUpdated(){this.body.hidden=!this.open,this.body.style.height=this.open?"auto":"0"}handleSummaryClick(){this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.open?this.hide():this.show()),"ArrowUp"!==t.key&&"ArrowLeft"!==t.key||(t.preventDefault(),this.hide()),"ArrowDown"!==t.key&&"ArrowRight"!==t.key||(t.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.emit("sl-show",{cancelable:!0}).defaultPrevented)return void(this.open=!1);await Be(this.body),this.body.hidden=!1;const{keyframes:t,options:e}=We(this,"details.show",{dir:this.localize.dir()});await Ne(this.body,Fe(t,this.body.scrollHeight),e),this.body.style.height="auto",this.emit("sl-after-show")}else{if(this.emit("sl-hide",{cancelable:!0}).defaultPrevented)return void(this.open=!0);await Be(this.body);const{keyframes:t,options:e}=We(this,"details.hide",{dir:this.localize.dir()});await Ne(this.body,Fe(t,this.body.scrollHeight),e),this.body.hidden=!0,this.body.style.height="auto",this.emit("sl-after-hide")}}async show(){if(!this.open&&!this.disabled)return this.open=!0,Re(this,"sl-after-show")}async hide(){if(this.open&&!this.disabled)return this.open=!1,Re(this,"sl-after-hide")}render(){const t="rtl"===this.localize.dir();return Bt`
      <div
        part="base"
