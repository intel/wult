...
`;function Ue(t,e,i){return new Promise((s=>{if((null==i?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const o=t.animate(e,me(fe({},i),{duration:window.matchMedia("(prefers-reduced-motion: reduce)").matches?0:i.duration}));o.addEventListener("cancel",s,{once:!0}),o.addEventListener("finish",s,{once:!0})}))}function De(t){return Promise.all(t.getAnimations().map((t=>new Promise((e=>{const i=requestAnimationFrame(e);t.addEventListener("cancel",(()=>i),{once:!0}),t.addEventListener("finish",(()=>i),{once:!0}),t.cancel()})))))}function He(t,e){return t.map((t=>me(fe({},t),{height:"auto"===t.height?`${e}px`:t.height})))}var Oe=new Map,Ne=new WeakMap;function Re(t,e){return"rtl"===e.toLowerCase()?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function Me(t,e){Oe.set(t,function(t){return null!=t?t:{keyframes:[],options:{duration:0}}}(e))}function Fe(t,e,i){const s=Ne.get(t);if(null==s?void 0:s[e])return Re(s[e],i.dir);const o=Oe.get(e);return o?Re(o,i.dir):{keyframes:[],options:{duration:0}}}var Be,Ve=new Set,je=new MutationObserver(Ye),qe=new Map,We=document.documentElement.dir||"ltr",Ke=document.documentElement.lang||navigator.language;function Ye(){We=document.documentElement.dir||"ltr",Ke=document.documentElement.lang||navigator.language,[...Ve.keys()].map((t=>{"function"==typeof t.requestUpdate&&t.requestUpdate()}))}je.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]});var Xe=class extends class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){Ve.add(this.host)}hostDisconnected(){Ve.delete(this.host)}dir(){return`${this.host.dir||We}`.toLowerCase()}lang(){return`${this.host.lang||Ke}`.toLowerCase()}term(t,...e){const i=this.lang().toLowerCase().slice(0,2),s=this.lang().length>2?this.lang().toLowerCase():"",o=qe.get(s),r=qe.get(i);let n;if(o&&o[t])n=o[t];else if(r&&r[t])n=r[t];else{if(!Be||!Be[t])return console.error(`No translation found for: ${String(t)}`),t;n=Be[t]}return"function"==typeof n?n(...e):n}date(t,e){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),e).format(t)}number(t,e){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),e).format(t)}relativeTime(t,e,i){return new Intl.RelativeTimeFormat(this.lang(),i).format(t,e)}}{};!function(...t){t.map((t=>{const e=t.$code.toLowerCase();qe.has(e)?qe.set(e,Object.assign(Object.assign({},qe.get(e)),t)):qe.set(e,t),Be||(Be=t)})),Ye()}({$code:"en",$name:"English",$dir:"ltr",clearEntry:"Clear entry",close:"Close",copy:"Copy",currentValue:"Current value",hidePassword:"Hide password",loading:"Loading",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",toggleColorFormat:"Toggle color format"});var Ze=class{constructor(t,...e){this.slotNames=[],(this.host=t).addController(this),this.slotNames=e,this.handleSlotChange=this.handleSlotChange.bind(this)}hasDefaultSlot(){return[...this.host.childNodes].some((t=>{if(t.nodeType===t.TEXT_NODE&&""!==t.textContent.trim())return!0;if(t.nodeType===t.ELEMENT_NODE){const e=t;if("sl-visually-hidden"===e.tagName.toLowerCase())return!1;if(!e.hasAttribute("slot"))return!0}return!1}))}hasNamedSlot(t){return null!==this.host.querySelector(`:scope > [slot="${t}"]`)}test(t){return"[default]"===t?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}handleSlotChange(t){const e=t.target;(this.slotNames.includes("[default]")&&!e.name||e.name&&this.slotNames.includes(e.name))&&this.host.requestUpdate()}},Ge=t=>(...e)=>({_$litDirective$:t,values:e}),Je=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}},Qe=Ge(class extends Je{constructor(t){var e;if(super(t),1!==t.type||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){var i,s;if(void 0===this.et){this.et=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!(null===(i=this.st)||void 0===i?void 0:i.has(t))&&this.et.add(t);return this.render(e)}const o=t.element.classList;this.et.forEach((t=>{t in e||(o.remove(t),this.et.delete(t))}));for(const t in e){const i=!!e[t];i===this.et.has(t)||(null===(s=this.st)||void 0===s?void 0:s.has(t))||(i?(o.add(t),this.et.add(t)):(o.remove(t),this.et.delete(t)))}return Rt}}),ti=t=>null!=t?t:Mt;function ei(t,e,i){const s=new CustomEvent(e,fe({bubbles:!0,cancelable:!1,composed:!0,detail:{}},i));return t.dispatchEvent(s),s}function ii(t,e){return new Promise((i=>{t.addEventListener(e,(function s(o){o.target===t&&(t.removeEventListener(e,s),i())}))}))}var si=class extends oe{constructor(){super(...arguments),this.hasSlotController=new Ze(this,"footer"),this.localize=new Xe(this),this.open=!1,this.label="",this.noHeader=!1}connectedCallback(){super.connectedCallback(),this.modal=new class{constructor(t){this.tabDirection="forward",this.element=t,this.handleFocusIn=this.handleFocusIn.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleKeyUp=this.handleKeyUp.bind(this)}activate(){Se.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Se=Se.filter((t=>t!==this.element)),document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Se[Se.length-1]===this.element}checkFocus(){if(this.isActive()&&!this.element.matches(":focus-within")){const{start:t,end:e}=function(t){var e,i;const s=[];return function t(e){e instanceof HTMLElement&&(s.push(e),null!==e.shadowRoot&&"open"===e.shadowRoot.mode&&t(e.shadowRoot)),[...e.children].forEach((e=>t(e)))}(t),{start:null!=(e=s.find((t=>Ee(t))))?e:null,end:null!=(i=s.reverse().find((t=>Ee(t))))?i:null}}(this.element),i="forward"===this.tabDirection?t:e;"function"==typeof(null==i?void 0:i.focus)&&i.focus({preventScroll:!0})}}handleFocusIn(){this.checkFocus()}handleKeyDown(t){"Tab"===t.key&&t.shiftKey&&(this.tabDirection="backward"),requestAnimationFrame((()=>this.checkFocus()))}handleKeyUp(){this.tabDirection="forward"}}(this)}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.modal.activate(),ze(this))}disconnectedCallback(){super.disconnectedCallback(),Pe(this)}async show(){if(!this.open)return this.open=!0,ii(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ii(this,"sl-after-hide")}requestClose(t){if(ei(this,"sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const t=Fe(this,"dialog.denyClose",{dir:this.localize.dir()});Ue(this.panel,t.keyframes,t.options)}else this.hide()}handleKeyDown(t){"Escape"===t.key&&(t.stopPropagation(),this.requestClose("keyboard"))}async handleOpenChange(){if(this.open){ei(this,"sl-show"),this.originalTrigger=document.activeElement,this.modal.activate(),ze(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([De(this.dialog),De(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame((()=>{ei(this,"sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")}));const e=Fe(this,"dialog.show",{dir:this.localize.dir()}),i=Fe(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([Ue(this.panel,e.keyframes,e.options),Ue(this.overlay,i.keyframes,i.options)]),ei(this,"sl-after-show")}else{ei(this,"sl-hide"),this.modal.deactivate(),await Promise.all([De(this.dialog),De(this.overlay)]);const t=Fe(this,"dialog.hide",{dir:this.localize.dir()}),e=Fe(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([Ue(this.panel,t.keyframes,t.options),Ue(this.overlay,e.keyframes,e.options)]),this.dialog.hidden=!0,Pe(this);const i=this.originalTrigger;"function"==typeof(null==i?void 0:i.focus)&&setTimeout((()=>i.focus())),ei(this,"sl-after-hide")}}render(){return Ot`
      <div
        part="base"
    ...
    `}};si.styles=Le,ge([Ae(".dialog")],si.prototype,"dialog",2),ge([Ae(".dialog__panel")],si.prototype,"panel",2),ge([Ae(".dialog__overlay")],si.prototype,"overlay",2),ge([$e({type:Boolean,reflect:!0})],si.prototype,"open",2),ge([$e({reflect:!0})],si.prototype,"label",2),ge([$e({attribute:"no-header",type:Boolean,reflect:!0})],si.prototype,"noHeader",2),ge([ye("open",{waitUntilFirstUpdate:!0})],si.prototype,"handleOpenChange",1),si=ge([_e("sl-dialog")],si),Me("dialog.show",{keyframes:[{opacity:0,transform:"scale(0.8)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}}),Me("dialog.hide",{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.8)"}],options:{duration:250,easing:"ease"}}),Me("dialog.denyClose",{keyframes:[{transform:"scale(1)"},{transform:"scale(1.02)"},{transform:"scale(1)"}],options:{duration:250}}),Me("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}}),Me("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});var oi=ct`
  ${ne}
...
`,$i=class extends Je{constructor(t){if(super(t),this.it=Mt,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Mt||null==t)return this.ft=void 0,this.it=t;if(t===Rt)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this.ft;this.it=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}};$i.directiveName="unsafeHTML",$i.resultType=1,Ge($i);var xi=class extends $i{};xi.directiveName="unsafeSVG",xi.resultType=2;var ki,Ai=Ge(xi),Ci=class extends oe{constructor(){super(...arguments),this.svg="",this.label="",this.library="default"}connectedCallback(){super.connectedCallback(),mi.push(this)}firstUpdated(){this.setIcon()}disconnectedCallback(){var t;super.disconnectedCallback(),t=this,mi=mi.filter((e=>e!==t))}getUrl(){const t=gi(this.library);return this.name&&t?t.resolver(this.name):this.src}redraw(){this.setIcon()}async setIcon(){var t;const e=gi(this.library),i=this.getUrl();if(ki||(ki=new DOMParser),i)try{const s=await async function(t){if(_i.has(t))return _i.get(t);const e=await function(t,e="cors"){if(yi.has(t))return yi.get(t);const i=fetch(t,{mode:e}).then((async t=>({ok:t.ok,status:t.status,html:await t.text()})));return yi.set(t,i),i}(t),i={ok:e.ok,status:e.status,svg:null};if(e.ok){const t=document.createElement("div");t.innerHTML=e.html;const s=t.firstElementChild;i.svg="svg"===(null==s?void 0:s.tagName.toLowerCase())?s.outerHTML:""}return _i.set(t,i),i}(i);if(i!==this.getUrl())return;if(s.ok){const i=ki.parseFromString(s.svg,"text/html").body.querySelector("svg");null!==i?(null==(t=null==e?void 0:e.mutator)||t.call(e,i),this.svg=i.outerHTML,ei(this,"sl-load")):(this.svg="",ei(this,"sl-error"))}else this.svg="",ei(this,"sl-error")}catch(t){ei(this,"sl-error")}else this.svg.length>0&&(this.svg="")}handleChange(){this.setIcon()}render(){const t="string"==typeof this.label&&this.label.length>0;return Ot` <div
    ...
    >
      ${Ai(this.svg)}
    </div>`}};Ci.styles=wi,ge([xe()],Ci.prototype,"svg",2),ge([$e({reflect:!0})],Ci.prototype,"name",2),ge([$e()],Ci.prototype,"src",2),ge([$e()],Ci.prototype,"label",2),ge([$e({reflect:!0})],Ci.prototype,"library",2),ge([ye("name"),ye("src"),ye("library")],Ci.prototype,"setIcon",1),Ci=ge([_e("sl-icon")],Ci);const{H:Ei}=J,Si=t=>(...e)=>({_$litDirective$:t,values:e}),Ti=(t,e)=>{var i,s;const o=t._$AN;if(void 0===o)return!1;for(const t of o)null===(s=(i=t)._$AO)||void 0===s||s.call(i,e,!1),Ti(t,e);return!0},zi=t=>{let e,i;do{if(void 0===(e=t._$AM))break;i=e._$AN,i.delete(t),t=e}while(0===(null==i?void 0:i.size))},Pi=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(void 0===i)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),Ui(e)}};function Ii(t){void 0!==this._$AN?(zi(this),this._$AM=t,Pi(this)):this._$AM=t}function Li(t,e=!1,i=0){const s=this._$AH,o=this._$AN;if(void 0!==o&&0!==o.size)if(e)if(Array.isArray(s))for(let t=i;t<s.length;t++)Ti(s[t],!1),zi(s[t]);else null!=s&&(Ti(s,!1),zi(s));else Ti(this,t)}const Ui=t=>{var e,i,s,o;2==t.type&&(null!==(e=(s=t)._$AP)&&void 0!==e||(s._$AP=Li),null!==(i=(o=t)._$AQ)&&void 0!==i||(o._$AQ=Ii))};class Di extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Pi(this),this.isConnected=t._$AU}_$AO(t,e=!0){var i,s;t!==this.isConnected&&(this.isConnected=t,t?null===(i=this.reconnected)||void 0===i||i.call(this):null===(s=this.disconnected)||void 0===s||s.call(this)),e&&(Ti(this,t),zi(this))}setValue(t){if((t=>void 0===this._$Ct.strings)())this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}class Hi{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class Oi{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){var t;null!==(t=this.Z)&&void 0!==t||(this.Z=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Z=this.q=void 0}}const Ni=t=>!(t=>null===t||"object"!=typeof t&&"function"!=typeof t)(t)&&"function"==typeof t.then,Ri=Si(class extends Di{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CK=new Hi(this),this._$CX=new Oi}render(...t){var e;return null!==(e=t.find((t=>!Ni(t))))&&void 0!==e?e:O}update(t,e){const i=this._$Cyt;let s=i.length;this._$Cyt=e;const o=this._$CK,r=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const n=e[t];if(!Ni(n))return this._$Cwt=t,n;t<s&&n===i[t]||(this._$Cwt=1073741823,s=0,Promise.resolve(n).then((async t=>{for(;r.get();)await r.get();const e=o.deref();if(void 0!==e){const i=e._$Cyt.indexOf(n);i>-1&&i<e._$Cwt&&(e._$Cwt=i,e.setValue(t))}})))}return O}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});class Mi{constructor(t){this.message=t,this.name="InvalidTableFileException"}}class Fi extends it{static properties={file:{type:File},template:{attribute:!1}};static styles=r`
        table {
            table-layout: fixed;
    ...
    `;getWidth(t){return Math.min(100,20*(t-2))}async*makeTextFileLineIterator(t){const e=new TextDecoder("utf-8"),i=t.stream().getReader();let{value:s,done:o}=await i.read();s=s?e.decode(s,{stream:!0}):"";const r=/\r\n|\n|\r/gm;let n=0;for(;;){const t=r.exec(s);if(t)yield s.substring(n,t.index),n=r.lastIndex;else{if(o)break;const t=s.substr(n);({value:s,done:o}=await i.read()),s=t+(s?e.decode(s,{stream:!0}):""),n=r.lastIndex=0}}n<s.length&&(yield s.substr(n))}render(){if(!this.file)return H``;const t=this.parseSrc();return H`${Ri(t,H``)}`}}customElements.define("sc-report-table",Fi),customElements.define("sc-intro-tbl",class extends Fi{parseHeader(t){const e=t.split(";");return H`
            <tr>
                ${e.map((t=>H`<th>${t}</th>`))}
            </tr>
        `}parseRow(t){let e=H``,i=!0;for(const s of t.split(";")){const[t,o,r]=s.split("|");let n=H`${t}`;r&&(n=H`<a href=${r}>${n}</a>`),o&&(n=H`<abbr title=${o}>${n}</abbr>`),i?(e=H`${e}
                    <td class="td-colname">
                        ${n}
                    </td>
                `,i=!1):e=H`${e}
...
`,Zi=class extends oe{constructor(){super(...arguments),this.localize=new Xe(this),this.attrId=Yi(),this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}focus(t){this.tab.focus(t)}blur(){this.tab.blur()}handleCloseClick(){ei(this,"sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return this.id=this.id.length>0?this.id:this.componentId,Ot`
    ...
    `}};Zi.styles=Xi,ge([Ae(".tab")],Zi.prototype,"tab",2),ge([$e({reflect:!0})],Zi.prototype,"panel",2),ge([$e({type:Boolean,reflect:!0})],Zi.prototype,"active",2),ge([$e({type:Boolean})],Zi.prototype,"closable",2),ge([$e({type:Boolean,reflect:!0})],Zi.prototype,"disabled",2),ge([$e()],Zi.prototype,"lang",2),ge([ye("active")],Zi.prototype,"handleActiveChange",1),ge([ye("disabled")],Zi.prototype,"handleDisabledChange",1),Zi=ge([_e("sl-tab")],Zi);var Gi=ct`
  ${ne}
...
`,Ji=class extends oe{constructor(){super(...arguments),this.attrId=Yi(),this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return Ot`
      <div
        part="base"
    ...
    `}};Ji.styles=Gi,ge([$e({reflect:!0})],Ji.prototype,"name",2),ge([$e({type:Boolean,reflect:!0})],Ji.prototype,"active",2),ge([ye("active")],Ji.prototype,"handleActiveChange",1),Ji=ge([_e("sl-tab-panel")],Ji);var Qi=ct`
  ${ne}
...
`,{H:es}=ie,is={},ss=Ge(class extends Je{constructor(t){if(super(t),3!==t.type&&1!==t.type&&4!==t.type)throw Error("The `live` directive is not allowed on child or event bindings");if(!(t=>void 0===t.strings)(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===Rt||e===Mt)return e;const i=t.element,s=t.name;if(3===t.type){if(e===i[s])return Rt}else if(4===t.type){if(!!e===i.hasAttribute(s))return Rt}else if(1===t.type&&i.getAttribute(s)===e+"")return Rt;return((t,e=is)=>{t._$AH=e})(t),e}});function os(t,e,i){return t?e():null==i?void 0:i()}function rs(t){return t&&"treeitem"===t.getAttribute("role")}var ns=class extends oe{constructor(){super(...arguments),this.localize=new Xe(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=0===this.getChildrenItems().length,this.handleExpandedChange()}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,ei(this,"sl-lazy-load")):this.animateExpand():this.animateCollapse()}async animateExpand(){ei(this,"sl-expand"),await De(this.childrenContainer),this.childrenContainer.hidden=!1;const{keyframes:t,options:e}=Fe(this,"tree-item.expand",{dir:this.localize.dir()});await Ue(this.childrenContainer,He(t,this.childrenContainer.scrollHeight),e),this.childrenContainer.style.height="auto",ei(this,"sl-after-expand")}async animateCollapse(){ei(this,"sl-collapse"),await De(this.childrenContainer);const{keyframes:t,options:e}=Fe(this,"tree-item.collapse",{dir:this.localize.dir()});await Ue(this.childrenContainer,He(t,this.childrenContainer.scrollHeight),e),this.childrenContainer.hidden=!0,ei(this,"sl-after-collapse")}getChildrenItems({includeDisabled:t=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter((e=>rs(e)&&(t||!e.disabled))):[]}isNestedItem(){const t=this.parentElement;return!!t&&rs(t)}handleToggleExpand(t){t.preventDefault(),t.stopImmediatePropagation(),this.disabled||(this.expanded=!this.expanded)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=0===this.getChildrenItems().length}willUpdate(t){t.has("selected")&&!t.has("indeterminate")&&(this.indeterminate=!1)}render(){const t="rtl"===this.localize.dir(),e=!this.loading&&(!this.isLeaf||this.lazy);return Ot`
      <div
        part="base"
      ...
      >
        ...
        >
          ...
          >
            ${os(this.loading,(()=>Ot` <sl-spinner></sl-spinner> `))}
            ${os(e,(()=>Ot`
...
`,ms=class extends oe{constructor(){super(...arguments),this.localize=new Xe(this)}render(){return Ot`
...
`,ys=class extends oe{constructor(){super(...arguments),this.localize=new Xe(this),this.position=50,this.vertical=!1,this.disabled=!1,this.snapThreshold=12}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver((t=>this.handleResize(t))),this.updateComplete.then((()=>this.resizeObserver.observe(this))),this.detectSize(),this.cachedPositionInPixels=this.percentageToPixels(this.position)}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver.unobserve(this)}detectSize(){const{width:t,height:e}=this.getBoundingClientRect();this.size=this.vertical?e:t}percentageToPixels(t){return this.size*(t/100)}pixelsToPercentage(t){return t/this.size*100}handleDrag(t){const e="rtl"===this.localize.dir();this.disabled||(t.preventDefault(),function(t,e){function i(i){const s=t.getBoundingClientRect(),o=t.ownerDocument.defaultView,r=s.left+o.pageXOffset,n=s.top+o.pageYOffset,a=i.pageX-r,l=i.pageY-n;(null==e?void 0:e.onMove)&&e.onMove(a,l)}document.addEventListener("pointermove",i,{passive:!0}),document.addEventListener("pointerup",(function t(){document.removeEventListener("pointermove",i),document.removeEventListener("pointerup",t),(null==e?void 0:e.onStop)&&e.onStop()})),(null==e?void 0:e.initialEvent)&&i(e.initialEvent)}(this,{onMove:(t,i)=>{let s=this.vertical?i:t;"end"===this.primary&&(s=this.size-s),this.snap&&this.snap.split(" ").forEach((t=>{let i;i=t.endsWith("%")?this.size*(parseFloat(t)/100):parseFloat(t),e&&!this.vertical&&(i=this.size-i),s>=i-this.snapThreshold&&s<=i+this.snapThreshold&&(s=i)})),this.position=as(this.pixelsToPercentage(s),0,100)},initialEvent:t}))}handleKeyDown(t){if(!this.disabled&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(t.key)){let e=this.position;const i=(t.shiftKey?10:1)*("end"===this.primary?-1:1);t.preventDefault(),("ArrowLeft"===t.key&&!this.vertical||"ArrowUp"===t.key&&this.vertical)&&(e-=i),("ArrowRight"===t.key&&!this.vertical||"ArrowDown"===t.key&&this.vertical)&&(e+=i),"Home"===t.key&&(e="end"===this.primary?100:0),"End"===t.key&&(e="end"===this.primary?0:100),this.position=as(e,0,100)}}handlePositionChange(){this.cachedPositionInPixels=this.percentageToPixels(this.position),this.positionInPixels=this.percentageToPixels(this.position),ei(this,"sl-reposition")}handlePositionInPixelsChange(){this.position=this.pixelsToPercentage(this.positionInPixels)}handleVerticalChange(){this.detectSize()}handleResize(t){const{width:e,height:i}=t[0].contentRect;this.size=this.vertical?i:e,this.primary&&(this.position=this.pixelsToPercentage(this.cachedPositionInPixels))}render(){const t=this.vertical?"gridTemplateRows":"gridTemplateColumns",e=this.vertical?"gridTemplateColumns":"gridTemplateRows",i="rtl"===this.localize.dir(),s=`\n      clamp(\n        0%,\n        clamp(\n          var(--min),\n          ${this.position}% - var(--divider-width) / 2,\n          var(--max)\n        ),\n        calc(100% - var(--divider-width))\n      )\n    `;return"end"===this.primary?i&&!this.vertical?this.style[t]=`${s} var(--divider-width) auto`:this.style[t]=`auto var(--divider-width) ${s}`:i&&!this.vertical?this.style[t]=`auto var(--divider-width) ${s}`:this.style[t]=`${s} var(--divider-width) auto`,this.style[e]="",Ot`
  ...
  `;static properties={path:{type:String},_visible:{type:Boolean,state:!0}};connectedCallback(){super.connectedCallback(),this.observer=new IntersectionObserver(((t,e)=>{t.forEach((t=>{t.isIntersecting?this._visible=!0:this._visible=!1}))})),this.observer.observe(this.parentElement)}disconnectedCallback(){super.disconnectedCallback(),this.observer.disconnect()}constructor(){super(),this._visible=!1}hideLoading(){this.renderRoot.querySelector("#loading").style.display="none"}render(){return this._visible?H`
            ...
            `:H``}}customElements.define("sc-diagram",_s);var ws=ct`
  ${ne}
...
`,ks=class extends oe{constructor(){super(...arguments),this.localize=new Xe(this),this.open=!1,this.disabled=!1}firstUpdated(){this.body.hidden=!this.open,this.body.style.height=this.open?"auto":"0"}async show(){if(!this.open&&!this.disabled)return this.open=!0,ii(this,"sl-after-show")}async hide(){if(this.open&&!this.disabled)return this.open=!1,ii(this,"sl-after-hide")}handleSummaryClick(){this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.open?this.hide():this.show()),"ArrowUp"!==t.key&&"ArrowLeft"!==t.key||(t.preventDefault(),this.hide()),"ArrowDown"!==t.key&&"ArrowRight"!==t.key||(t.preventDefault(),this.show())}async handleOpenChange(){if(this.open){ei(this,"sl-show"),await De(this.body),this.body.hidden=!1;const{keyframes:t,options:e}=Fe(this,"details.show",{dir:this.localize.dir()});await Ue(this.body,He(t,this.body.scrollHeight),e),this.body.style.height="auto",ei(this,"sl-after-show")}else{ei(this,"sl-hide"),await De(this.body);const{keyframes:t,options:e}=Fe(this,"details.hide",{dir:this.localize.dir()});await Ue(this.body,He(t,this.body.scrollHeight),e),this.body.hidden=!0,this.body.style.height="auto",ei(this,"sl-after-hide")}}render(){return Ot`
      <div
        part="base"
    ...
    `;static properties={title:{type:String},paths:{type:Object},diff:{type:String}};getFileContents(t){return new Promise((function(e,i){fetch(t).then((t=>{if(!t.ok)throw new Error(`HTTP error: status ${t.status}`);return t.blob()})).then((t=>t.text())).then((t=>{e(t)}))}))}getNewTabBtnTemplate(t){return H`
        ...
        `}getDiffTemplate(){if(this.diff){const t=`${this.title}-diff`;return H`
            ...
            `}return H``}getTabTemplate(t,e){const i=`details-panel-${this.title}-${t}`;return H`
            ...
            <sl-tab-panel class="tab-panel" name=${i}>
                <div class="text-field-container">
                    ...
                    <pre><code>${Ri(this.getFileContents(e),H`Loading...`)}</code></pre>
                </div>
            </sl-tab-panel>
        `}render(){return H`
        ...
        `}parseSummaryFunc(t){const[e,i]=t.split("|");return H`
            <td class="td-value">
                ${i?H`<abbr title=${i}>${e}</abbr>`:H`${e}`}
            </td>
        `}async parseSrc(){let t,e=H``;for await(const i of this.makeTextFileLineIterator(this.file)){const s=i.split(";"),o=s[0];if(s.shift(),"H"===o)for(const t of s)e=H`${e}<th>${t}</th>`,this.cols=this.cols+1;else if("M"===o)t=this.parseMetric(s);else{const i=H`${s.map((t=>this.parseSummaryFunc(t)))}`;e=H`
                    ${e}
                    <tr>
                      ${t}
                      ${i}
                    </tr>
                `,t&&(t=void 0)}}return e=H`<table ${Ss(this.tableRef)} width=${this.getWidth(this.cols)}>${e}</table>`,H`
  ...
  `;static properties={paths:{type:Array},alerts:{type:Array},fpreviews:{type:Array},smrytblpath:{type:String},smrytblfile:{type:Blob}};render(){return this.smrytblpath&&!this.smrytblfile&&fetch(this.smrytblpath).then((t=>t.blob())).then((t=>{this.smrytblfile=t})),H`
        ...
        `}}customElements.define("sc-data-tab",zs),customElements.define("sc-tab-panel",class extends it{static properties={tab:{type:Object}};selectTabInTabTree(t){const e=this.renderRoot.querySelectorAll("sl-tree-item[selected]");for(const t of e)t.selected=!1;const i=this.renderRoot.querySelectorAll("sl-tree-item[expanded]");for(const t of i)t.expanded=!1;let s=this.renderRoot.getElementById(`${t}-tree`);for(s.selected=!0;"SL-TREE-ITEM"===s.tagName;)s.expanded=!0,s=s.parentElement}hasDataTab(t){return this.dataTabs.includes(t)}show(t){if(!this.hasDataTab(t))return;if(this.activeDataTab?.id===t)return;this.activeDataTab&&(this.activeDataTab.hidden=!0);const e=this.renderRoot.getElementById(t);this.activeDataTab=e,e&&(e.hidden=!1),this.selectTabInTabTree(t)}tabPanesTemplate(t){let e=H``;for(const i of t.tabs)e=i.tabs?H`${e}${this.tabPanesTemplate(i)}`:H`${e}
                    ...
                    </sc-data-tab>`;return e}firstUpdated(){this.show(this.firstTab)}treeItemTemplate(t){return t.tabs?H`
            ${t.name}
            ${t.tabs.map((t=>H`
                ...
                `))}
        `:(this.dataTabs.push(t.id),this.firstTab||(this.firstTab=t.id),t.name)}render(){return this.tab?H`
        ...
        `:H``}constructor(){super(),this.dataTabs=[],this.firstTab=""}});class Ps extends it{static styles=r`
        /*
    ...
    `;static properties={tabs:{type:Object}};get _tabPanels(){return this.renderRoot.querySelectorAll("sc-tab-panel")}get _tabGroup(){return this.renderRoot.querySelector("sl-tab-group")}getTabPanel(t){for(const e of this._tabPanels)if(e.hasDataTab(t))return e}getActiveTab(){const t=this._tabGroup.querySelectorAll("sl-tab");for(const e of t)if(e.active)return e;throw Error("BUG: unable to find active tab")}getActiveDataTab(){const t=this.getActiveTab();for(const e of this._tabPanels)if(e.tab.name===t.panel)return e.activeDataTab;throw Error("BUG: unable to find active data tab")}show(t=location.hash.substring(1)){for(const e of this._tabPanels)e.show(t)}firstUpdated(){this.tabChangeHandler=()=>{location.href=`#${this.getActiveDataTab().id}`},this._tabGroup.addEventListener("sl-tab-show",this.tabChangeHandler),this._tabGroup.updateComplete.then((()=>{const t=location.hash.substring(1);if(!t)return void(location.hash=`${this._tabPanels[0].firstTab}`);const e=this.getTabPanel(t);e.updateComplete.then((()=>{e.show(t),this._tabGroup.show(e.parentElement.name)}))}))}connectedCallback(){super.connectedCallback(),this.hashHandler=()=>{this.show()},window.addEventListener("hashchange",this.hashHandler,!1)}disconnectedCallback(){window.removeEventListener("hashchange",this.hashHandler),this._tabGroup.removeEventListener("sl-tab-show",this.tabChangeHandler)}render(){return this.tabs?H`
      ...
      `:H``}}customElements.define("sc-tab-group",Ps);class Is extends it{static properties={introtbl:{type:Object},src:{type:String},reportInfo:{type:Object},toolname:{type:String},titleDescr:{type:String},tabs:{type:Object},fetchFailed:{type:Boolean,attribute:!1}};static styles=r`
        .report-head {
            display: flex;
            flex-direction: column;
            align-items: center;
    ...
    `;get _corsWarning(){return this.renderRoot.querySelector(".cors-warning")}initRepProps(){this.reportTitle=this.reportInfo.title,this.reportDescr=this.reportInfo.descr}generateTabIDs(t){for(const e of t){e.tabs&&(e.tabs=this.generateTabIDs(e.tabs));const t=e.name.replace(/\s/g,"-").replace("%","Percent").replace(/[^a-zA-Z0-9-]+/g,"");this.tabIDs.has(t)?(this.tabIDs.set(t,this.tabIDs.get(t)+1),e.id=`${t}-${this.tabIDs.get(t)}`):(this.tabIDs.set(t,0),e.id=t)}return t}parseReportInfo(t){this.reportInfo=t,this.initRepProps(),t.intro_tbl&&fetch(t.intro_tbl).then((t=>t.blob())).then((t=>{this.introtbl=t})),fetch(t.tab_file).then((t=>t.json())).then((async t=>{this.tabs=this.generateTabIDs(t)}))}connectedCallback(){fetch(this.src).then((t=>t.json())).then((t=>this.parseReportInfo(t))).catch((t=>{if(!(t instanceof TypeError))throw t;this.fetchFailed=!0})),super.connectedCallback()}updated(t){t.has("fetchFailed")&&this.fetchFailed&&this._corsWarning.addEventListener("sl-request-close",(t=>{t.preventDefault()}))}corsWarning(){return H`
        ...
        `}findFile(t){const e=Object.keys(this.files);for(const i of e)if(i.endsWith(t))return this.files[i];throw Error(`unable to find an uploaded file ending with '${t}'.`)}async extractTabs(t,e){for(const i of t)i.smrytblpath&&(i.smrytblfile=e?await fetch(i.smrytblpath).then((t=>t.blob())):this.findFile(i.smrytblpath)),i.tabs&&(i.tabs=await this.extractTabs(i.tabs,e));return this.generateTabIDs(t)}async processUploadedFiles(){const t=this.renderRoot.getElementById("upload-files");this.files={};for(const e of t.files)this.files[e.webkitRelativePath]=e;const e=await this.findFile("report_info.json").arrayBuffer();this.reportInfo=JSON.parse((new TextDecoder).decode(e)),this.introtbl=this.findFile(this.reportInfo.intro_tbl);const i=await this.findFile(this.reportInfo.tab_file).arrayBuffer().then((t=>JSON.parse((new TextDecoder).decode(t))));this.tabs=await this.extractTabs(i,!1),this.initRepProps(),this.fetchFailed=!1}constructor(){super(),this.fetchFailed=!1,this.reportInfo={},this.tabIDs=new Map}render(){return this.fetchFailed?this.corsWarning():H`
            ...
            <br>
            <div class="sticky">
                ${this.tabs?H`<sc-tab-group .tabs=${this.tabs}></sc-tab-group>`:H``}
            </div>
        `}}customElements.define("sc-report-page",Is),pi("shoelace")})();