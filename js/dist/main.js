...
`,Qe=t=>null!=t?t:Wt,Ye=class extends $e{constructor(){super(...arguments),this.label="",this.disabled=!1}render(){const t=!!this.href,e=jt`
      <sl-icon
        name=${Qe(this.name)}
...
`,cs=class extends At{constructor(t){if(super(t),this.it=Wt,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Wt||null==t)return this.vt=void 0,this.it=t;if(t===Dt)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this.vt;this.it=t;const e=[t];return e.raw=e,this.vt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};cs.directiveName="unsafeHTML",cs.resultType=1,wt(cs);var ds=class extends cs{};ds.directiveName="unsafeSVG",ds.resultType=2;var ps=wt(ds),us=new DOMParser,vs=class extends $e{constructor(){super(...arguments),this.svg="",this.library="default"}connectedCallback(){super.connectedCallback(),ns.push(this)}firstUpdated(){this.setIcon()}disconnectedCallback(){var t;super.disconnectedCallback(),t=this,ns=ns.filter((e=>e!==t))}getUrl(){const t=as(this.library);return this.name&&t?t.resolver(this.name):this.src}redraw(){this.setIcon()}async setIcon(){const t=as(this.library),e=this.getUrl();if(e)try{const s=await(t=>{if(ls.has(t))return ls.get(t);{const e=fetch(t).then((async t=>{if(t.ok){const e=document.createElement("div");e.innerHTML=await t.text();const s=e.firstElementChild;return{ok:t.ok,status:t.status,svg:s&&"svg"===s.tagName.toLowerCase()?s.outerHTML:""}}return{ok:t.ok,status:t.status,svg:null}}));return ls.set(t,e),e}})(e);if(e!==this.getUrl())return;if(s.ok){const e=us.parseFromString(s.svg,"text/html").body.querySelector("svg");e?(t&&t.mutator&&t.mutator(e),this.svg=e.outerHTML,Ie(this,"sl-load")):(this.svg="",Ie(this,"sl-error",{detail:{status:s.status}}))}else this.svg="",Ie(this,"sl-error",{detail:{status:s.status}})}catch(t){Ie(this,"sl-error",{detail:{status:-1}})}else this.svg&&(this.svg="")}handleChange(){this.setIcon()}render(){const t="string"==typeof this.label&&this.label.length>0;return jt` <div
    ...
    >
      ${ps(this.svg)}
    </div>`}};vs.styles=hs,ut([Ve()],vs.prototype,"svg",2),ut([Fe()],vs.prototype,"name",2),ut([Fe()],vs.prototype,"src",2),ut([Fe()],vs.prototype,"label",2),ut([Fe()],vs.prototype,"library",2),ut([Be("name"),Be("src"),Be("library")],vs.prototype,"setIcon",1),vs=ut([De("sl-icon")],vs);class bs extends et{static styles=o`
        table {
            table-layout: fixed;
...
`,Ts=0,ks=class extends $e{constructor(){super(...arguments),this.localize=new As(this),this.componentId="sl-tab-"+ ++Ts,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1}focus(t){this.tab.focus(t)}blur(){this.tab.blur()}handleCloseClick(){Ie(this,"sl-close")}render(){return this.id=this.id||this.componentId,jt`
    ...
    `}};ks.styles=Cs,ut([qe(".tab")],ks.prototype,"tab",2),ut([Fe({reflect:!0})],ks.prototype,"panel",2),ut([Fe({type:Boolean,reflect:!0})],ks.prototype,"active",2),ut([Fe({type:Boolean})],ks.prototype,"closable",2),ut([Fe({type:Boolean,reflect:!0})],ks.prototype,"disabled",2),ut([Fe()],ks.prototype,"lang",2),ks=ut([De("sl-tab")],ks);var Us=ce`
  ${Ne}
